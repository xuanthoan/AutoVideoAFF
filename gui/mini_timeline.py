...
if QWidget:
    class MiniTimelineTracks(QWidget):
        ...
        def __init__(self) -> None:
            ...
            self.setStyleSheet("background:#FAFBFC;border:1px solid #E1E5EA;border-radius:10px;")
        ...
        def paintEvent(self, event):
            ...
            for idx in range(first_row, last_row):
                item = self.items[idx]
                y = self._row_y(idx)
                painter.setPen(QColor("#6B7280" if item.visible else "#9CA3AF"))
    ...
    class MiniTimeline(QWidget):
        ...
        def __init__(self) -> None:
            ...
            self.setStyleSheet("QWidget{background:#FFFFFF;color:#1F2937;} QPushButton{background:#FFFFFF;color:#1F2937;border:1px solid #D8DEE8;padding:3px 8px;border-radius:8px;min-height:30px;} QPushButton:hover{background:#EEF4FF;border-color:#93C5FD;} QListWidget{background:#FAFBFC;color:#1F2937;border:1px solid #D8DEE8;border-radius:8px;}")
