...
if QWidget:
    class WorkflowPanel(QWidget):
        ...
        def _apply_compact_widget_style(self) -> None:
            self.setStyleSheet(
                """
                QWidget { font-size: 11px; color: #1F2937; background: #F5F7FA; }
                QGroupBox { color: #1F2937; font-weight: 700; letter-spacing: 0.7px; margin-top: 8px; padding-top: 6px; border: 1px solid #E1E5EA; border-radius: 12px; background: #FFFFFF; }
                QGroupBox::title { subcontrol-origin: margin; left: 10px; padding: 0 5px; background: #FFFFFF; color: #1F2937; }
                ...
                QPushButton { min-height: 32px; max-height: 38px; padding: 4px 9px; border-radius: 9px; border: 1px solid #D8DEE8; background: #FFFFFF; color: #1F2937; }
                QPushButton:hover { background: #EEF4FF; border-color: #93C5FD; }
                QPushButton:pressed, QPushButton:checked { background: #DBEAFE; border-color: #2563EB; color: #1D4ED8; }
                QComboBox, QSpinBox, QDoubleSpinBox { min-height: 30px; max-height: 34px; padding: 1px 6px; border: 1px solid #D8DEE8; border-radius: 7px; background: #FFFFFF; color: #1F2937; }
